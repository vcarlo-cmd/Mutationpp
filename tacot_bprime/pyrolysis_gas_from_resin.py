...
if __name__ == "__main__":
    ...
    print()
    print("  CONFIRMÉ PAR LA MESURE — Sykes, NASA TN D-3810, table II :")
    print("     novolac Union Carbide BRP 5549 + hexaméthylènetétramine,")
    print("     analysé à l'ambiante : C 75.60  H 6.12  N 2.35  O 15.93 % masse")
    print("     soit, hors azote piégé : C 77.42  H 6.27  O 16.31")
    print("     formule brute C6.32 H6.10 O1 — bien le motif phénolique.")
    print("     (L'azote vient de la HMTA et disparaît dès 400 °C.)")
    print("     Détail et fermeture croisée : resine_tacot_verification.py")
