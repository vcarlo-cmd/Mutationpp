#!/usr/bin/env python
"""
Génère et trace la table B' du TACOT dans l'air.
Utilise le binaire C++ MutationPP `bprime` comme moteur de calcul.

Char = carbone pur (fibres de carbone + résine carbonisée), sans pyrolyse
(B'g = 0). La table est calculée pour une plage de pressions de 0.001 à
1000 atm (espacement logarithmique) et une plage de températures de 300 à
5000 K.

Usage :
    python tacot_bprime_simple.py
...
BG         = "0.0"          # débit pyrolyse adimensionné (0 = char pur)
MIXTURE    = "tacot-air_25"
BL_COMP    = "air"
PYRO_COMP  = "tacot_pyro"
# Pas de -char/-char-elem : le char du TACOT est du carbone pur, identique
# au char par défaut intégré à bprime (vérifié : sorties identiques).
...
def plot_bprime_table(all_data, pressures_atm):
    ...
    plt.tight_layout()
    out_png = "tacot_bprime_simple_table.png"
...
if __name__ == "__main__":
    ...
    out_csv = "tacot_bprime_simple_table.csv"
